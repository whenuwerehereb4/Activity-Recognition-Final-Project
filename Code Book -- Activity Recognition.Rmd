---
title: "Code Book — Activity Recognition Variables"
author: "Andrew Nix"
date: "3/7/2017"
...
in the R script and README file):  
*Note 3:  The variable names are identical in both objects.  In one case they refer to the original observations and in the second case they represents a summation of those observations.   For further clarification, here is an explanation of the 2 objects:
...
columns, subject and activity) in the *subjxactivityxfeature_COMBINED* (described above) data frame across all observations associated with the the same subject AND
...
corresponding labels in the data) are as follows:  
* 1) WALKING   
* 2) WALKING_UPSTAIRS  
...
#Qunatitative Features

##Overview of the Quantiative Data 
